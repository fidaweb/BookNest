...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'https://fidaullah.test/Project/api/sslcommerz'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID',$STORE_ID); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD',$STORE_PASSWORD); // your store password.
}
